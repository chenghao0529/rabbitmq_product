...
import com.chenghao.config.ExchangeConfig;
import com.chenghao.config.RabbitmqConfig;
...
public class Send  {
    ...
    public void sendMsg(Person person){
        ...
        CorrelationData correlationData = new CorrelationData(person.getUsername() + "" + System.currentTimeMillis());
        rabbitTemplate.setConfirmCallback(confirmCallback);
        rabbitTemplate.setReturnCallback(returnCallback);
        rabbitTemplate.convertAndSend(ExchangeConfig.TEST_EXCHANGE,RabbitmqConfig.TEST_ROUTINGKEY,person,correlationData);
    }
}
